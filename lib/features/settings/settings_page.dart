...
class _SettingsPageState extends State<SettingsPage> {
  ...
  Future<void> _logout() async {
    ...
    try {
      ...
      // 2) Sign out first — removes session from storage (secure/local/web).
      await _supa.auth.signOut();

      // 3) Now it's safe to fully nuke caches + web localStorage.
      ...
      if (mounted) {
        ...
        // Navigate AFTER pop; avoid double-navigation elsewhere.
