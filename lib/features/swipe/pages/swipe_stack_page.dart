      ...
      builder: (context, box) {
        ...
        return Center(
          child: SizedBox(
            width: cardW,
            height: cardH,
            // ⬇️ New: background layer behind the swipe stack
            child: Stack(
              children: [
                Positioned.fill(
                  // why: pure visual backdrop, must not intercept taps/drags
                  child: IgnorePointer(
                    child: ColoredBox(
                      color: Colors.black.withValues(alpha: 0.1), // "slightly transparent" black
                    ),
                  ),
                ),
                // ⬇️ Existing stack unchanged
                SwipableStack(
                  controller: _stack,
