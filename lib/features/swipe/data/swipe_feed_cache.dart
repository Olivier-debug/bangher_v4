...
// Why: integrates with global CacheWiper without changing call sites.
void _registerSwipeWipeHook() {
  CacheWiper.registerHook(() async {
    SwipeFeedCache.instance.wipeAll(); // keep overrides & position by default
  });
}

// ignore: unused_element
final bool _swipeWipeHookRegistered = (() { _registerSwipeWipeHook(); return true; })();
