...
import '../chat/widgets/peer_avatar.dart'; // Use PeerAvatar in header
        ...
        child: AppBar(
          ...
          title: Row(
            children: [
              ...
              // Swapped to PeerAvatar (renders online dot internally)
              PeerAvatar(
                userId: _peerUserId ?? '',
                online: _peerOnline,
                size: 44,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            fontSize: 11,
                            color: Colors.white.withValues(alpha: mine ? 0.8 : 0.7),
                          ),
                        ),
                      ],
                    ),
