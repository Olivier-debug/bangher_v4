...
class ChatPage extends StatefulWidget {
  ...
  /// Needed by GoRouter and const lists in router.dart
  static const String routePath = '/chat';
  static const String routeName = 'chat';

  /// Optional: typed route factory.
...
class _ChatPageState extends State<ChatPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final othersTyping =
        _typingUserIds.where((id) => id != _currentUserId).toList(growable: false);
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: TextStyle(
                              fontSize: 11,
                              // Use withOpacity for broader Flutter versions.
