...
class _CreateOrCompleteProfilePageState
  ...
  Future<void> _onAddPhotoNextOpen() async {
    ...
    try {
      ...
      if (slot == null) {
        ...
        if (mounted) { _safeUpdateProfile({'profile_pictures': _nonNullPictures()}); }
      }
      _scheduleSaveDraft();
    } catch (e) {
  ...
  Future<void> _onSave() async {
    ...
    try {
      ...
      if (mounted) { _safeUpdateProfile(profileMap); }
      ...
      if (mounted) { _safeInvalidateMyProfile(); }
