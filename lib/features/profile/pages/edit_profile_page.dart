...
class _EditProfilePageState extends ConsumerState<EditProfilePage> {
  ...
  // ---- Crop dialog (now shows in-dialog progress + disabled buttons while cropping) ----
          ...
          builder: (ctx, setStateDialog) {
            Future<void> startCrop() async {
              ...
              try {
                ...
                result = data;
                // brief frame so the overlay is visible
...
Future<Uint8List> _cropEncodeIsolate(Map<String, dynamic> m) async {
  ...
  final int q = qualityIn < 1 ? 1 : (qualityIn > 100 ? 100 : 100.clamp(0, 100));
