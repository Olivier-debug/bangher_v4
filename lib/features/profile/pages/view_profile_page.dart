                                    ...
                                    child: PageView.builder(
                                      ...
                                      itemBuilder: (context, i) {
                                        ...
                                        return GestureDetector(
                                          ...
                                          child: Hero(
                                            tag: i == 0
                                                ? 'public_profile_photo_${widget.userId}'
                                                : 'public_profile_photo_$i',
...
class _ShimmerLine extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    Widget box = const _ShimmerBox(height: 12, radius: 6);
    box = _ShimmerBox(height: height, radius: 6);
