  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label:
            const Text('Confess', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w600)),
      ),
    );
  }
              ...
              children: [
                ...
                Switch(
                  ...
                  thumbIcon: WidgetStateProperty.resolveWith(
                      (states) => Icon(_anon ? Icons.visibility_off : Icons.person)),
              ...
              ClipRRect(
                ...
                child: FutureBuilder<Uint8List>(
                  ...
                  builder: (context, snap) {
                    if (!snap.hasData) {
                      // COLOR CHANGE: skeleton grey
                      return Container(height: 180, color: Color(0xFF202227));
                    }
                    return Image.memory(
                      snap.data!,
                      fit: BoxFit.cover,
                ...
                child: Hero(
                  ...
                  child: ClipRRect(
                    ...
                    child: CachedNetworkImage(
                      ...
                      fit: BoxFit.cover,
                      // COLOR CHANGE: skeleton grey placeholder & error
                      placeholder: (_, __) =>
                          Container(height: 220, color: Color(0xFF202227)),
      ...
      child: Row(
        children: [
          CircleAvatar(
            ...
            child:
                avatar == null ? const Icon(Icons.person, color: Colors.white54) : null,
          ),
...
class _ActionsRow extends StatelessWidget {
  const _ActionsRow(
      {required this.item, required this.onToggleLike, required this.onOpenComments});
  final ConfessionItem item;
  final VoidCallback onToggleLike;
  final VoidCallback onOpenComments;
    ...
    return Scaffold(
      ...
      body: _loading
          ...
          : item == null
              ? const Center(
                  child:
                      Text('Confession not found', style: TextStyle(color: Colors.white70)))
              : ListView(
                      ...
                      Hero(
                        ...
                        child: ClipRRect(
                          ...
                          child: CachedNetworkImage(
                            ...
                            // COLOR CHANGE: skeleton grey
                            placeholder: (_, __) =>
                                Container(height: 260, color: Color(0xFF202227)),
                          ),
                        ),
                      ),
                    ],
                    ...
                    _ActionsRow(
                        ...
                        onToggleLike: () async {
                          ...
                          await Supabase.instance.client
                              .rpc('toggle_confession_like', params: {
                            'p_confession_id': item.id,
                          });
                          if (!mounted) return;
                          setState(() {
  ...
  Future<void> _load() async {
    try {
      final rows = await _supa
          ...
          .select(
              'id, confession_id, author_user_id, text, created_at, profiles(name, profile_pictures)')
  ...
  Future<void> _send() async {
    ...
    try {
      ...
      final me = CommentItem(
        ...
        authorAvatarUrl:
            (prof['avatar_url'] ?? '') == '' ? null : prof['avatar_url'].toString(),
        text: text,
        createdAt:
            DateTime.tryParse((row['created_at'] ?? '').toString()) ?? DateTime.now().toUtc(),
      );
      if (!mounted) return;
      setState(() {
        _comments.add(me);
    ...
    return ListView.builder(
      ...
      itemBuilder: (_, i) {
        return Padding(
          ...
          child: Container(
            decoration: BoxDecoration(
              // COLOR CHANGE: match other skeleton cards
    ...
    return Align(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          // COLOR CHANGE: darker skeleton gradient to match previous loaders
