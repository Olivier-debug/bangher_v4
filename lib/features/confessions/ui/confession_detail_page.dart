                ...
                Row(
                  children: [
                    ...
                    IconButton(
                      ...
                      onPressed: () async {
                        // cache messenger BEFORE the async gap to avoid using BuildContext later
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: theme.AppTheme.ffPrimary.withValues(alpha: .18),
        borderRadius: BorderRadius.circular(8),
        border: Border.all(color: theme.AppTheme.ffAlt.withValues(alpha: .35), width: 1),
      ),
