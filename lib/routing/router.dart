      ...
      GoRoute(
        ...
        pageBuilder: (context, state) => NoTransitionPage(
          child: _AppScaffold(
            ...
            currentLocation: state.matchedLocation,
            showHeader: true, // <-- add header for Confessions
    ...
    switch (variant) {
      case _HeaderVariant.profile:
        return AppBar(
          ...
          centerTitle: false,
          titleSpacing: 12,
          title: const _BrandLogo(), // consistent logo size
          actions: <Widget>[
            Padding(
      ...
      case _HeaderVariant.swipe:
        return AppBar(
          ...
          leading: const Padding(
            ...
            child: _BrandLogo(), // consistent logo size
          ),
          actions: <Widget>[
      ...
      case _HeaderVariant.confessions:
        // Matches the removed in-page header: Logo + Notifications + Tips
        return AppBar(
          toolbarHeight: _kHeaderHeight,
          centerTitle: false,
          titleSpacing: 12,
          title: const _BrandLogo(), // consistent logo size across pages
          actions: <Widget>[
            IconButton(
